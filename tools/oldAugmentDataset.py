    ...
    for root, dirs, files in os.walk(image_dir):
        ...
        for file in files:
            if file.endswith((".jpg", ".png")):
                ...
                # Process and save the labels, if label file exists
                if os.path.exists(lbl_path):
                    with open(lbl_path, 'r') as file:
                        ...
                        class_ids = []
                        for line in lines:
                            # Assuming the format is 'class_id x1 y1 x2 y2 ...' for polygons
...
dataset_root = r"/Users/cam/Programming/DataAugmentationPipeline/Dataset"
...
skip_augmentations = {
    'Zoom' : [],
    'Crop' : ['sean_buoy', 'indoor_buoy', 'woollett_buoy'],
    'Rotate' : [],
    'Mirror' : ['desert_gate','gate_close','gate_med','indoor_gate_cold','indoor_gate_hot','sean_gate_cold','sean_gate_hot'],
}
...
overlay_weights = [95,5]
overlay_min_max_scale = [0.3,1.0]
coco_image_dir = r"/Users/cam/Programming/DataAugmentationPipeline/unlabeled2017"
