...
def convert_coco_to_yolo(json_file_path, output_dir='data'):
    # Load COCO JSON
    ...
    output_dir = os.path.join(output_dir, json_base_name)
...
# Example usage
json_file_path = r'/Users/cam/Downloads/indoor_mapp/annotations/instances_default.json'
output_dir = 'output_data'
convert_coco_to_yolo(json_file_path, output_dir)
